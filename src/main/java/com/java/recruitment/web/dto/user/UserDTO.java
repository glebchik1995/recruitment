...
public class UserDTO {
    ...
    @NotNull(message = "Имя должно быть не null.", groups = {OnCreate.class, OnUpdate.class})
    ...
    @NotNull(message = "Пароль не должен быть null.", groups = {OnCreate.class, OnUpdate.class})
